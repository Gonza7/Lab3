...
<body>
    ...
    $id=$_GET["id"];
    $sql="SELECT * FROM auto WHERE cod_auto=$id";
    ...
    <form action="procModAuto.php" method="post">
        <table class="tab" align="center">
            ...
            <tr>
                ...
                <td><input type="text" name="mar" id="mar" value="<?php echo $v[1]?>"></td>
            </tr>
            <tr>
                <td><label for="">Modelo:</label></td>
                <td><input type="text" name="mod" id="mod" value="<?php echo $v[2]?>"></td>
            </tr>
            <tr>
                <td><label for="">Color:</label></td>
                <td><input type="text" name="col" id="col" value="<?php echo $v[3]?>"></td>
            </tr>
            <tr>
                <td><label for="">Precio venta:</label></td>
                <td><input type="number" name="pv" id="pv" value="<?php echo $v[4]?>"></td>
            </tr>
            <tr>
                ...
                <td>
                    <select name="cli" id="cli">
                        ...
                        while($cli=mysqli_fetch_array($res)){
                            if($cli[0]==$v[5]){
                                echo "<option value='$cli[0]' selected>$cli[0] - $cli[1]</option>";
                            }else{
